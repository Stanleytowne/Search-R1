...
# 数据路径
TRAIN_FILE=/scratch/mrm2vx/tpz/Search-R1/data/toolbench_stage1/Sports.parquet
VAL_FILE=/scratch/mrm2vx/tpz/Search-R1/data/toolbench_stage1/Sports.parquet
...
EXPERIMENT_NAME=toolbench_stage1_$(date +%Y%m%d_%H%M%S)
WANDB_PROJECT=Search-R1-stage1
TOTAL_EPOCHS=3
NUM_GPUS=4
LR=1e-5
BATCH_SIZE=64
